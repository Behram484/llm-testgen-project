...
class XStringSupportTest {
 ...
 @Test
 void testGetNumberStringNegative() {
 assertEquals("-01", XStringSupport.getNumberString(-1, 3));
 assertThrows(IllegalArgumentException.class, () -> XStringSupport.getNumberString(1, 2));
 }
 
 @Test
 void testSuccessorUsualCharsLengthFix() {
 assertEquals(" ", XStringSupport.successorUsualChars("~", true));
